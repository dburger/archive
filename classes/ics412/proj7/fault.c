...
asmlinkage void do_page_fault(struct pt_regs *regs, unsigned long error_code)
{
	...
	tsk = current;
        /* added by dburger for page fault metering */
...
/*
 * Used to init the page fault meter.
 *
 * @param pid  pid to track, 0 for all
 *                           actual pid for specific
 *                           -1 to turn off
 */
...
/*
 * Used to return the current value of the page faults in relation
 * to the time unit indicated by span.
 *
 * @param span  used to indicate the time frame to consider when
 *              returning current rate of page faults
 */
