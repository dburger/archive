 ...
 */
public class AdjacencyListGraph implements Graph, Serializable {
    ...
    public Enumeration verticesReverse() {
        return new ReverseSequenceEnumerator(V);
    }
    ...
    public Enumeration edgesReverse() {
        return new ReverseSequenceEnumerator(E);
    }
...
//        return v.outEdges();
    ...
    public void replaceVertexObject(Position vp, Object o) throws InvalidPositionException {
      Vertex v = checkVertexPosition(vp);
      v.replaceObject(o);
    }

    public void replaceEdgeObject(Position ep, Object o) throws InvalidPositionException {
      Edge e = checkEdgePosition(ep);
      e.replaceObject(o);
    }
