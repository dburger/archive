...
public class GraphApp extends Applet implements ActionListener {
    ...
    public void init() {
        ...
        //START - TITLE
        Label title = new Label("Graph Applet", Label.CENTER);
        ...
        lblVertices.setBackground(outerColor);
        gb.gridx = 0;
        gb.gridy = 1;
        gb.gridheight = 1;
        gb.gridwidth = 1;
        gl.setConstraints(lblVertices,gb);
        add(lblVertices);
    
        txtVertices = new TextField("20");
        txtVertices.setBackground(outerColor);
        gb.gridx = 1;
        gb.gridy = 1;
        gb.gridheight = 1;
        gb.gridwidth = 1;
        gl.setConstraints(txtVertices,gb);
        add(txtVertices);
    
        Label lblDensity = new Label("Edge Density:", Label.CENTER);
        lblDensity.setBackground(outerColor);
        gb.gridx = 2;
        gb.gridy = 1;
        gb.gridheight = 1;
        gb.gridwidth = 1;
        gl.setConstraints(lblDensity,gb);
        add(lblDensity);
    
        txtDensity = new TextField("20");
        txtDensity.setBackground(outerColor);
        gb.gridx = 3;
        gb.gridy = 1;
        gb.gridheight = 1;
        gb.gridwidth = 1;
        gl.setConstraints(txtDensity,gb);
        add(txtDensity);
        ...
        gb.gridheight = 1;
        gb.gridwidth = 1;
        gl.setConstraints(cboGraphOp,gb);
        add(cboGraphOp);
        ...
        cboGraphOp.addItem("MST example 3");
        ...
        gb.gridheight = 1;
        gb.gridwidth = 1;
        gl.setConstraints(cmdGo,gb);
        add(cmdGo);
        cmdGo.addActionListener(this);

        txtOutput = new TextArea(); //"", 150, 0);
//        txtOutput.setFont(new Font("Courier New",Font.BOLD,10));
//        gb.fill = gb.BOTH;
        gb.gridx = 0;
        gb.gridy = 2;
        gb.gridheight = 2;
        gb.gridwidth = 6;
        gl.setConstraints(txtOutput,gb);
        add(txtOutput);
    ...
    */
    ...
    private void doGraphOp() {
        if(cboGraphOp.getSelectedItem().equals("Random Max Flow")) {
            ...
            doMSTExample2();
        } else if(cboGraphOp.getSelectedItem().equals("MST example 3")) {
            doMSTExample3();
        }
    ...
    private void doMSTExample3() {
        txtOutput.setText("");
        txtOutput.append("another example\n");
        txtOutput.append("another example\n");
    }
