...
var XpiInstaller = {
	...
	extFullName: 'Text Dumper', // The name displayed to the user (don't include the version)
	extShortName: 'textdumper', // The leafname of the JAR file (without the .jar part)
	extVersion: '0.1',
	extAuthor: 'David J. Burger',
	extLocaleNames: null, // e.g. ['en-US', 'en-GB']
	extSkinNames: null, // e.g. ['classic', 'modern']
	extPostInstallMessage: 'Text Dumper was installed successfully.  Please restart your browser to finish the installation.', // Set to null for no post-install message
	// --- Editable items end ---
