...
public class ArraySequence implements Sequence {
    ...
    public Object removeElemAtRank(int rank) throws BoundaryViolationException {
        ...
        //of the sequence will be asymptotically faster
    ...
    public Object remove(Position pos) throws InvalidPositionException {
        //in this case we don't really need the ArrayPosition
        //only making this call to make sure Position pos is valid
        ArrayPosition ap = checkPosition(pos);
        Object e = ap.element();
        //make the Position invalid for this container
//        ap.setContainer(null);
        removeElemAtRank(rankOf(ap));
        return e;
    }
